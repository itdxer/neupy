...
.. csv-table::
    ...
    "ResNet50", "~25.5 millions", `resnet50.hdf5 <http://neupy.s3.amazonaws.com/tensorflow/imagenet-models/resnet50.hdf5>`_, `resnet50.py <https://github.com/itdxer/neupy/blob/master/examples/cnn/resnet50.py>`_
    "SqueezeNet", "~1.2 million", `squeezenet.hdf5 <http://neupy.s3.amazonaws.com/tensorflow/imagenet-models/squeezenet.hdf5>`_, `squeezenet.py <https://github.com/itdxer/neupy/blob/master/examples/cnn/squeezenet.py>`_
    "VGG16", "~138 million", `vgg16.hdf5 <http://neupy.s3.amazonaws.com/tensorflow/imagenet-models/vgg16.hdf5>`_, `vgg16.py <https://github.com/itdxer/neupy/blob/master/examples/cnn/vgg16.py>`_
    "VGG19", "~143 million", `vgg19.hdf5 <http://neupy.s3.amazonaws.com/tensorflow/imagenet-models/vgg19.hdf5>`_, `vgg19.py <https://github.com/itdxer/neupy/blob/master/examples/cnn/vgg19.py>`_
